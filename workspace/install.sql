...
-- Do NOT seed admin credentials here. Run the first-boot setup script instead:
--   node API/scripts/setup-admin.js
-- This generates a random secure password and forces a password change on first login.
-- See deployment/SETUP.md for instructions.
